Locales['en'] = {
    ...
    -- Ban strings
    ['checking'] = '🛡️[Anticheat]🛡️ | You are currently being checked...',
    ['user_ban_reason'] = '⛔[Anticheat]⛔ | You have been banned ( 𝗨𝘀𝗲𝗿𝗻𝗮𝗺𝗲: %s ) | Wrong? Contact the server Admins Click here: https://discord.gg/ ',
    ['user_kick_reason'] = '⛔[Anticheat]⛔ | You have been kicked ( 𝗥𝗲𝗮𝘀𝗼𝗻: %s )',
    ['banlist_ban_reason'] = 'Player has tried to trigger \'%s\' event',
    ['banlist_not_loaded_kick_player'] = '⛔[Anticheat]⛔ | Our bans hasn\'t loaded, you\'ll have to wait a couple of seconds. Try again later!',
    ['ip_not_found'] = '⛔[Anticheat]⛔ | We couldn\'t find your IP',
    ['ip_blocked'] = '⛔[Anticheat]⛔| You have a VPN active, disable it to join the server | Wrong? Contact the server owners',
    ['new_identifiers_found'] = '%s, new identifier(s) found - original ban %s',
    ['failed_to_load_banlist'] = '⛔[Anticheat]⛔ Failed to load Banlist!',
    ['failed_to_load_tokenlist'] = '⛔[Anticheat]⛔ Failed to load Tokenlist!',
    ['failed_to_load_ips'] = '⛔[Anticheat]⛔ Failed to load IPs!',
    ['failed_to_load_check'] = '⛔[Anticheat]⛔ Please check this error soon, Bans *will not* work!',
    ...
    -- Discord
    ['discord_title'] = '⛔[Anticheat]⛔ Has banned a player',
